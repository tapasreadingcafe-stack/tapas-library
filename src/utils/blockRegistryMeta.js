...
export const BLOCK_REGISTRY_META = {
  hero: {
    ...
    schema: [
      ...
      { key: 'cta_secondary_text', label: 'Secondary button text', type: 'text', hint: 'Used by Two buttons preset.' },
      { key: 'cta_secondary_href', label: 'Secondary button link', type: 'text' },
      { key: 'align',            label: 'Alignment',    type: 'select', options: [
        { value: 'left', label: 'Left' }, { value: 'center', label: 'Center' },
      ]},
      { key: 'background_image', label: 'Background',   type: 'image', hint: 'Used by Video bg, Centered presets.' },
      { key: 'overlay_opacity',  label: 'Overlay',      type: 'number', min: 0, max: 1 },
      { key: 'image_url',        label: 'Image (split)', type: 'image', hint: 'Used by Split / Image left presets.' },
      {
        key: 'stats', label: 'Stats (With stats preset)', type: 'array',
      ...
      {
        key: 'chips', label: 'Chips (With chips preset)', type: 'array',
  ...
  navbar: {
    ...
    schema: [
      ...
      { key: 'tagline',          label: 'Tagline',      type: 'text', hint: 'Used by the Brand + tagline preset.' },
      { key: 'cta_text',         label: 'Button text',  type: 'text' },
      { key: 'cta_href',         label: 'Button link',  type: 'text' },
      { key: 'cta_secondary_text', label: 'Secondary button text', type: 'text', hint: 'Used by Two CTAs preset.' },
      { key: 'cta_secondary_href', label: 'Secondary button link', type: 'text' },
      { key: 'announcement_text', label: 'Announcement bar text', type: 'text', hint: 'Used by With announcement preset.' },
  ...
  footer: {
    ...
    schema: [
      ...
      { key: 'tagline',    label: 'Tagline',        type: 'text', hint: 'Used by Tagline / Mega / Tagline below presets.' },
      { key: 'background_color', label: 'Background', type: 'color' },
      { key: 'newsletter_headline', label: 'Newsletter headline', type: 'text', hint: 'Used by Newsletter preset.' },
