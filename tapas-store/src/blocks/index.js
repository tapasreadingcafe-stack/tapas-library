...
export const BLOCK_REGISTRY = {
  ...
  tapas_events_calendar: {
    label: 'Tapas Events Calendar (live)',
    category: 'Content',
    Renderer: TapasEventsCalendar,
    defaultProps: {
    ...
    schema: [
      ...
      { key: 'limit',        label: 'How many to show',  type: 'number', hint: '1–20. Defaults to 5.' },
      { key: 'cta_href',     label: 'Each row links to', type: 'text' },
    ],
  },

  tapas_pricing_split: {
    label: 'Tapas Pricing Split (Drop-in vs Membership)',
    category: 'Content',
    Renderer: TapasPricingSplit,
    defaultProps: {
    ...
    schema: [
      ...
      { key: 'heading_html',      label: 'Heading (HTML, <em> allowed)',  type: 'text' },
      { key: 'lede',              label: 'Lede paragraph',                type: 'textarea' },
      { key: 'left_kicker',       label: 'Left panel — kicker',           type: 'text' },
      { key: 'left_title',        label: 'Left panel — title',            type: 'text' },
      { key: 'left_body',         label: 'Left panel — body',             type: 'textarea' },
      { key: 'left_features',     label: 'Left panel — features',         type: 'array',
        itemDefaults: '', itemFields: [{ key: '_value', label: 'Feature', type: 'text' }] },
      { key: 'left_price',        label: 'Left panel — price',            type: 'text' },
      { key: 'left_cta_text',     label: 'Left panel — CTA text',         type: 'text' },
      { key: 'left_cta_href',     label: 'Left panel — CTA link',         type: 'text' },
      { key: 'right_kicker',      label: 'Right panel — kicker',          type: 'text' },
      { key: 'right_title',       label: 'Right panel — title',           type: 'text' },
      { key: 'right_body',        label: 'Right panel — body',            type: 'textarea' },
      { key: 'right_features',    label: 'Right panel — features',        type: 'array',
        itemDefaults: '', itemFields: [{ key: '_value', label: 'Feature', type: 'text' }] },
      { key: 'right_price',       label: 'Right panel — price',           type: 'text' },
  ...
  tapas_featured_testimonial: {
    label: 'Tapas Featured Testimonial (orange panel)',
    category: 'Content',
    Renderer: TapasFeaturedTestimonial,
    defaultProps: {
      source: 'static',
      background: '#FF934A',
    ...
    schema: [
      { key: 'source',         label: 'Source', type: 'select', options: [
        { value: 'static', label: 'Static (use the fields below)' },
        { value: 'live',   label: 'Live (featured row from home_testimonials)' },
      ]},
      { key: 'background',     label: 'Background color',                 type: 'color' },
      { key: 'kicker',         label: 'Kicker',                           type: 'text' },
      { key: 'quote_html',     label: 'Quote (HTML allowed)',             type: 'textarea' },
      { key: 'author_name',    label: 'Author name',                      type: 'text' },
      { key: 'author_context', label: 'Author context (role / location)', type: 'text' },
