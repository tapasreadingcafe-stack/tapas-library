...
export const JOURNAL_SIDEBAR = [
  {
    ...
    kickerColor: 'pink',
    title: [
      { t: 'Why we’re pressing ' },
      { t: 'Minor Detail', em: 'purple' },
      { t: ' into every hand this month.' },
    ],
    excerpt: "Shibli’s sentences sit so quietly on the page they make the room itself feel like it’s listening.",
  ...
  },
  {
    ...
    excerpt: 'A translator’s notebook: what to do when a sentence is faithful, legal, and still wrong.',
...
export const JOURNAL_ARCHIVE = [
  ...
  },
  {
    ...
    excerpt: "Transcripts from our Slow Fiction Club’s March meeting — what a first-time reader noticed that the rest of us had stopped seeing.",
    author: { name: 'Marisol', initial: 'M' },
    readMinutes: 8,
  ...
  },
  {
    ...
    excerpt: "Guest diarist Sean Cotter on C\u0103rt\u0103rescu’s Solenoid — and the week he lost to three consecutive subordinate clauses.",
